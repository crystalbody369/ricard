...
def sample():
    ...
    return _shell("サンプル", SAMPLE_BODY)
...
# ログイン後の相談画面のサンプル（ログイン不要で見られる＝審査・初見の人向け）。
SAMPLE_BODY = """<h1>理カード</h1><p class="tag">ログイン後の画面イメージ</p>
<div class="ok">🔎 これは<b>サンプル画面</b>です。ログイン後はこの画面で相談できます。実際のご利用には登録が必要です。</div>

<div class="card">
<h2>理に相談する</h2>
<p class="note" style="text-align:left;margin:0 0 10px">気になった出来事を書くと、理の視点で静かに観ます。当てるのではなく、整えるために。</p>
<label>気になった出来事</label>
<div style="border:1px solid var(--line);border-radius:9px;background:#fff;padding:11px 13px;font-size:15px;line-height:1.8;min-height:84px">大事なメールを送ろうとした直前に、パソコンが急に固まりました。再起動して見直したら、宛先を一人間違えていたことに気づきました。</div>
<label style="margin-top:10px">今の気持ち・状況・取り組んでいること（任意）</label>
<div style="border:1px solid var(--line);border-radius:9px;background:#fff;padding:11px 13px;font-size:15px;line-height:1.8">仕事を早く進めようと焦っていて、確認を後回しにしていました。</div>
<div class="btn" style="opacity:.55;cursor:default;margin-top:14px">理に観てもらう（サンプル）</div>
<div style="margin-top:16px;border-top:1px solid var(--line);padding-top:14px">
<p class="note" style="margin:0 0 6px">▼ 返ってくる回答（例）</p>
<div style="white-space:pre-wrap;line-height:1.95;font-size:15px;background:#fbf7ee;border:1px solid var(--line);border-radius:10px;padding:14px 15px">焦って「先に送ろう」とする気持ちが、確かめる目を薄くしていた。そこへ強制的に止められ、もう一度見る間ができた――そんな流れに見えます。一歩早く送るより、一手確かめてから送るほうが、結局は早いことがあります。送る前に三秒だけ止まる、その小さな間を意識してみては。意味は流してもよいですが、焦りだけはそっと受け取っておいてください。</div>
</div>
</div>

<div class="card"><h2>料金</h2>
<p>無料でお試し → 続けたい方は <b>相談30回ぶん ¥500</b>（買い切り）。</p></div>

<div class="card"><h2>実際に使うには</h2>
<p>現在は<b>招待制</b>です。紹介コードをお持ちの方はご登録ください。</p>
<a class="btn" href="/login">ログイン</a>　<a class="btn ghost" href="/register">紹介コードで登録</a></div>

<p class="lnk"><a href="/">← トップ（サービス説明）に戻る</a></p>"""
